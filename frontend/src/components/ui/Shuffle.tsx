      ...
      const build = () => {
        ...
        chars.forEach((ch: any) => {
          ...
          for (let k = 0; k < rolls; k++) {
            const c = ch.cloneNode(true) as any;
      ...
      const play = () => {
        ...
        const tl = gsap.timeline({
          ...
          onRepeat: () => {
            ...
            if (isVertical) {
              gsap.set(strips, { y: (i: number, t: any) => parseFloat(t.getAttribute('data-start-y') || '0') });
            } else {
              gsap.set(strips, { x: (i: number, t: any) => parseFloat(t.getAttribute('data-start-x') || '0') });
            }
            onShuffleComplete?.();
          },
          onComplete: () => {
        ...
        if (animationMode === 'evenodd') {
          const odd = strips.filter((_, i: number) => i % 2 === 1);
          const even = strips.filter((_, i: number) => i % 2 === 0);
